...
@Composable
fun NoteBottomNavigation(modifier: Modifier = Modifier, navController: NavController){
    NavigationBar(
        ...
        NavigationBarItem(
            ...
            label = {
                Text(text = stringResource(R.string.bottom_navigation_calendar)
                )
            },
            selected = false,
            onClick = {}
        ...
        NavigationBarItem(
            ...
            selected = false,
            onClick = {navController.navigate(Routes.ProfileRoute)}
        )
    }
}